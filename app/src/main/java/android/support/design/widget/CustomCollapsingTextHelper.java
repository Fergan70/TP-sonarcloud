...
public final class CustomCollapsingTextHelper {
    ...
    // Declare mIsRtl as a local variable in the relevant methods
    // private boolean mIsRtl;
    ...
    public void draw(Canvas canvas) {
        ...
        if (mTextToDraw != null && mDrawTitle) {
            ...
            scaleAndDrawText(canvas, x, y, drawTexture);
        }
    ...
    private void scaleAndDrawText(Canvas canvas, float x, float y, boolean drawTexture) {
        if (mScale != 1f) {
